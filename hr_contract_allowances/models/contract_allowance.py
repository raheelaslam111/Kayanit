...
class ContractAllowance(models.Model):
    ...
    state = fields.Selection([
        ('draft', 'Draft'),
        ('approve', 'Approved'),('close','Close')
    ], string="State", default='draft',track_visibility='onchange', copy=False)
    allowance_amount = fields.Float(string="Allowance Amount", required=True, track_visibility='onchange')
    ...
    installment_type = fields.Selection([
        ...
        ('installment_no', 'Installment No.'),('per_month','Monthly Allowance')
    ...
    payment_date = fields.Date(string="Installment Date",track_visibility='onchange',  default=fields.Date.today())
    employee_no = fields.Char('Employee No')
    salary = fields.Float()
    description = fields.Text(string="Description",track_visibility='onchange', required=True, copy=False)
    ...
    def compute_installment(self):
        ...
        company based on payment start date and the no of installments.
            """
        if any(allowance.status=='done' for allowance in self.allowance_lines):
            raise ValidationError("Some of entries in done state")
        for allowance in self:
